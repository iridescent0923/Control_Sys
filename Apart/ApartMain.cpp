...
class CApartCtrl : public ITcOCFCtrlImpl<CApartCtrl, CApartClassFactory>
{
public:
	CApartCtrl() {};
	virtual ~CApartCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("Apart: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CApartCtrl>;
